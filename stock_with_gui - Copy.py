...
def radar():
	...
	os.system(command)
def gaetz():
	url = "https://rumble.com/user/RepMattGaetz"
	command = "start \"\" "+url
	os.system(command)
	"""
def jones():
...
buttons_col_0.append(["gaetz",gaetz])
...
for a,val in enumerate(buttons_array):
	...
	for b,valb in enumerate(val):
		...
		"""
		just call stock.py and put in gui?
		#pesudocode
		#stock(inputs from gui as opposed to in python shell)
		#stock([])
		"""
mainloop()